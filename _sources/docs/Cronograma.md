...
El siguiente presupuesto detalla los costos estimados para la implementación y operación del Voluntariado Académico (VA) de CircleUp en Tocancipá durante 6 meses. Todos los valores están expresados en Pesos Colombianos (COP).

#### 2.1 Costos de Infraestructura y Tecnología

| Ítem | Costo Mensual | Costo Total (6 meses) | Descripción y Alternativas |
|------|---------------|------------------------|---------------------------|
| Servicios en la nube y Base de datos | 400,000 | 2,400,000 | **Opción principal**: Azure Cloud Services para hosting, procesamiento y Azure SQL Database para almacenamiento estructurado. Firestore como base de datos principal para datos en tiempo real y flexibilidad de esquema. **Alternativas**: (1) Google Cloud Platform con Cloud SQL y Firestore. (2) Amazon Web Services con RDS y DynamoDB. (3) DigitalOcean con Managed Databases. |
| Hosting web (anual) | - | 60,000 | **Opción principal**: Bluehost, hosting compartido con buen rendimiento y soporte. **Alternativas**: (1) SiteGround: Excelente velocidad y soporte técnico. (2) HostGator: Económico y fácil de usar. (3) A2 Hosting: Conocido por su velocidad y opciones ecológicas. |
| Plataforma de desarrollo | 50,000 | 300,000 | **Opción principal**: Streamlit para desarrollo rápido de aplicaciones web con Python. **Alternativas**: (1) Dash by Plotly: Para aplicaciones analíticas. (2) Flask + React: Para mayor flexibilidad en el frontend. (3) FastAPI: Para APIs de alto rendimiento con frontend separado. |
| APIs de IA Generativa | 100,000 | 600,000 | **Opciones**: (1) OpenAI API: Líder en modelos de lenguaje avanzados. (2) Anthropic Claude: Enfoque en IA ética y segura. (3) Google Gemini: Capacidades multimodales avanzadas. La elección dependerá de las necesidades específicas del proyecto y las pruebas de rendimiento. |
| Email API | 50,000 | 300,000 | **Opción principal**: SendGrid para envío masivo de correos. **Alternativas**: (1) Mailgun: Buena opción para desarrolladores. (2) Amazon SES: Económico para grandes volúmenes. (3) Mailchimp: Incluye herramientas de marketing por correo. |
| Herramienta de automatización | 80,000 | 480,000 | **Opción principal**: Make (anteriormente Integromat) para automatizaciones complejas y flujos de trabajo entre aplicaciones. **Alternativas**: (1) Zapier: Amplia gama de integraciones, pero potencialmente más costoso para volúmenes altos. (2) n8n: Opción de código abierto y autoalojada. (3) Automate.io: Buena opción para automatizaciones básicas a menor costo. |
| **Subtotal Infraestructura y Tecnología** | | **4,140,000** | |

#### 2.2 Costos de Personal

| Posición | Costo Mensual | Costo Total (6 meses) | Descripción |
|----------|---------------|------------------------|-------------|
| Owner (medio tiempo) | 500,000 | 3,000,000 | Responsable de la gestión general del proyecto, análisis de datos, desarrollo web y ejecución del presupuesto. Trabaja aproximadamente 20 horas semanales. |
| Asistente de Operaciones (medio tiempo) | 900,000 | 5,400,000 | Encargado de la atención a interesados, reclutamiento de voluntarios, creación de campañas digitales, promoción de cursos y gestión de mensajería. Trabaja aproximadamente 20 horas semanales, incluyendo los sábados. |
| **Subtotal Personal** | | **8,400,000** | |

#### 2.3 Costos de Marketing y Operaciones

| Ítem | Costo Total (6 meses) | Descripción y Alternativas |
|------|------------------------|---------------------------|
| Material POP | 600,000 | Materiales promocionales físicos como folletos, carteles y camisetas. **Alternativas**: (1) Marketing digital exclusivamente para reducir costos. (2) Asociarse con imprentas locales para descuentos. (3) Utilizar materiales ecológicos para alinearse con valores de sostenibilidad. |
| Campañas digitales | 800,000 | Publicidad en redes sociales (Facebook, Instagram, LinkedIn) y Google Ads. **Alternativas**: (1) Marketing de contenidos y SEO para reducir costos de publicidad. (2) Colaboraciones con influencers locales. (3) Utilizar plataformas de email marketing para campañas dirigidas. |
| Herramienta de diseño | 240,000 | **Opción principal**: Licencia Canva Pro para diseño de materiales gráficos. **Alternativas**: (1) Adobe Creative Cloud (más costoso pero más potente). (2) Figma (bueno para diseño colaborativo). (3) GIMP y Inkscape (opciones gratuitas de código abierto). |
| Alquiler de espacios (contingencia) | 360,000 | Presupuesto para hasta 3 eventos presenciales a 120,000 por día, solo en caso de no lograr acuerdos para uso de espacios públicos gratuitos. **Estrategias**: (1) Priorizar alianzas con entidades públicas para uso de espacios sin costo. (2) Explorar espacios al aire libre o comunitarios. (3) Rotar entre instalaciones de empresas locales como parte de su RSE. |
| **Subtotal Marketing y Operaciones** | **2,000,000** | |

#### 2.4 Reserva para Contingencias

```{admonition} Reserva para Contingencias
:class: warning
Se establece una reserva del 3% del presupuesto total para contingencias imprevistas durante la ejecución del proyecto.
```
...
4. **Adaptabilidad**: El cronograma y presupuesto deben mantenerse flexibles para adaptarse a las necesidades cambiantes de la comunidad de Tocancipá.
